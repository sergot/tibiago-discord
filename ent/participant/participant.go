...
const (
	...
	Table = "participants"
	// BosslistTable is the table that holds the bosslist relation/edge. The primary key declared below.
	BosslistTable = "bosslist_participants"
...
var (
	// BosslistPrimaryKey and BosslistColumn2 are the table columns denoting the
	// primary key for the bosslist relation (M2M).
	BosslistPrimaryKey = []string{"bosslist_id", "participant_id"}
)
